...
file_name_hadoop=hadoop-2.10.1.tar.gz
dl_link_hadoop=${apache_root_site}/hadoop/common/hadoop-2.10.1/hadoop-2.10.1.tar.gz
...
file_name_hive2=hive-2.3.7.tar.gz
dl_link_hive2=${apache_root_site}/hive/hive-2.3.7/apache-hive-2.3.7-bin.tar.gz
...
file_name_zeppelin=zeppelin-0.8.2.tgz
#dl_link_zeppelin=${apache_root_site}/zeppelin/zeppelin-0.7.3/zeppelin-0.7.3-bin-all.tgz
dl_link_zeppelin=${apache_root_site}/zeppelin/zeppelin-0.8.2/zeppelin-0.8.2-bin-all.tgz
...
file_name_hbase=hbase-2.3.3.tar.gz
dl_link_hbase=${apache_root_site}/hbase/2.3.3/hbase-2.3.3-bin.tar.gz
