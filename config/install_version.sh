...
file_name_hive2=hive-2.3.5.tar.gz
dl_link_hive2=${apache_root_site}/hive/hive-2.3.5/apache-hive-2.3.5-bin.tar.gz
...
dl_link_hbase=${apache_root_site}/hbase/1.3.5/hbase-1.3.5-bin.tar.gz
